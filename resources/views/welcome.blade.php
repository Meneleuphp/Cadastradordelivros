...
<h2>Acervo de Livros</h2>
    ...
    <div id="cards-container" class="row">
        ...
        <div class="card col-md-3">
            ...
            <div class="card-body">
                <p class="card-date">Data de Cadastro:{{date('d/m/y', strtotime($event->data))}}</p>
                <h5 class="card-title">Nome do livro:{{$event->title}}</h5>
                <p class="card-participants">Nº de páginas:{{$event->num_paginas}}</p>
