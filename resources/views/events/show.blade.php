    ...
    <div class="col-md-10 offset-md-1">
        <div class="row">
            ...
            <div id="info-container" class= "col-md-6">
                ...
                <p class="event-city"><img src = "/icon/boneco.png"  class="location">Autor: {{ $event->autor }}</p>
                <p class= "event-partipants"><img src = "/icon/paginas.png"  class="person"> Número de Páginas: {{$event->num_paginas}}</p>
